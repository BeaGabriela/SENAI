	...
	public static void fatorial() {
		...
		int f=1;
			...
			for( int i = v; i > 0; i-- ) {
				...
				System.out.printf("O fatorial do valor digitado é: %d", f);	
	}
	
	

	//5 Leia do usuário o valor do xerex e mostre uma tabela em que o número apareça multiplicado até 200,
	//sendo 10 em cada linha.
	//Esta tabela é útil para deixar afixada em lojas de Xerox, por exemplo.
